export type Framework = "next-app" | "next-pages" | "hono" | "express" | "fastify" | "koa" | "nestjs" | "elysia" | "adonis" | "trpc" | "sveltekit" | "remix" | "nuxt" | "flask" | "fastapi" | "django" | "celery" | "go-net-http" | "gin" | "fiber" | "echo" | "chi" | "rails" | "phoenix" | "spring" | "ktor" | "actix" | "axum" | "raw-http" | "php" | "laravel" | "aspnet" | "vapor" | "swiftui" | "flutter" | "android" | "roku-scenegraph" | "graphql" | "grpc" | "websocket" | "angular" | "unknown";
...
export interface BoocontextConfig {
    ...
    maxDepth?: number;
    /** Output directory name (default: ".boocontext") */
    outputDir?: string;
    /** AI tool profile */
...
export interface BoocontextPlugin {
...
export interface PluginDetectorResult {
    ...
    /** Custom markdown sections rendered into BOOCONTEXT.md and written as individual .md files */
    customSections?: {
        name: string;
        content: string;
    }[];
...
export interface ScanResult {
    ...
    /** Plugin-contributed custom sections (rendered into BOOCONTEXT.md alongside built-in sections) */
    customSections?: {
        name: string;
        content: string;
    }[];
