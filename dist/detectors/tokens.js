 ...
 */
export function calculateTokenStats(result, outputText, fileCount) {
    ...
    const specialRoutes = result.routes.filter((r) => ["QUERY", "MUTATION", "SUBSCRIPTION", "RPC"].includes(r.method));
    ...
    const rawExploration = routeCost + specialRouteCost + wsCost +
