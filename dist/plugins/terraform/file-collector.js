 ...
 */
export async function collectTfFiles(projectRoot, config) {
...
async function scanDirForTf(dir, maxDepth = 5) {
    const tfFiles = [];
    const tfvarsFiles = [];
    try {
        await stat(dir);
