...
export function createTypesTool(manager) {
    return {
        name: "boocontext_types",
        description: "TypeScript type recovery. Calls type-inject infer_type or resolve_signature to resolve cross-file TS types, interfaces, and generics.",
        inputSchema: {
            type: "object",
            properties: {
