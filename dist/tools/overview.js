...
export function createOverviewTool() {
    return {
        ...
        description: "Full codebase overview. Wraps boocontext scanner output in a verdict envelope with project summary, routes, schema, components, and dependency graph.",
        inputSchema: {
            type: "object",
            properties: {
