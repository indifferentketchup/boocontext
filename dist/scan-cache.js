...
let cachedRoot = null;
export async function getScanResult(directory) {
    ...
    const [rawHttpRoutes, schemas, components, libs, config, middleware, graph, graphqlRoutes, grpcRoutes, wsRoutes, events] = await Promise.all([
