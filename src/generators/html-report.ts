...
<title>${escapeHtml(project.name)} — boocontext report</title>
<style>
...
<div class="subtitle">AI Context Map — generated by boocontext</div>
...
<div class="token-hero">
  ...
  <div class="token-detail">
    Output: ${tokenStats.outputTokens.toLocaleString()} tokens — Exploration cost without boocontext: ~${tokenStats.estimatedExplorationTokens.toLocaleString()} tokens — ${tokenStats.fileCount} files scanned
  </div>
</div>
...
<div class="footer">
  Generated by <a href="https://github.com/Houseofmvps/boocontext">boocontext</a> — see your codebase clearly
</div>
