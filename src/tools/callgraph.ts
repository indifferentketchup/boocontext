...
export function createCallgraphTool(manager: ChildServerManager) {
  return {
    name: "boocontext_callgraph",
    description:
      "Call graph analysis. Calls tree-sitter-analyzer callers, callees, or call_graph depending on direction arg. Use to trace function call relationships.",
    inputSchema: {
      type: "object",
      properties: {
