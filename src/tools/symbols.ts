...
export function createSymbolsTool(manager: ChildServerManager) {
  return {
    name: "boocontext_symbols",
      description:
        "BM25-ranked symbol search. Calls tree-sitter-analyzer for semantic code search. Returns ranked results matching the query.",
    inputSchema: {
      type: "object",
      properties: {
